...
final class AgenceControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->manager->getRepository(Agence::class);
